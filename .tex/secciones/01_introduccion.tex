...
(EAM) de Pineda \& Morales y su extensión hetero-asociativa (EHAM)
\cite{pineda2021entropic,morales2024hetero}.
...
\begin{enumerate}
    ...
    Cada agente emplea cinco memorias (dos homo-asociativas de dominio, una
    hetero-asociativa de contenido texto$\leftrightarrow$imagen, y dos hetero-asociativas
    de directorio: una de texto y una visual); el TME incorpora dos directorios adicionales.
