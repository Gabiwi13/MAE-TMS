...
La Memoria Hetero-Asociativa Entrópica (EHAM) de Morales y Pineda~\cite{morales2024hetero}
...
(\emph{missing cue problem}): la pista fuente selecciona un plano de memoria en el dominio
destino, pero no existe una pista destino adicional para completar la recuperación.
El paper original propone métodos como \emph{random}, \emph{sample-and-test} y
\emph{sample-and-search}/\emph{search-and-test} para resolverlo.
El presente sistema usa esa idea como sustrato de asociación texto$\leftrightarrow$imagen y
como base para los directorios hetero-asociativos agente$\leftrightarrow$especialidad.
