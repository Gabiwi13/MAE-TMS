...
El sistema EAM-TMS contiene en total \textbf{14 memorias asociativas} distribuidas entre
...
\begin{table}[H]
\centering
\caption{Las 14 memorias asociativas del sistema EAM-TMS.
...
$M^R_{\mathrm{dir}}$) son hetero-asociativas cuyo dominio derecho codifica la identidad
del agente ganador.
...
semántica (o latente) de la pista se asocia al identificador del agente que ganó el
