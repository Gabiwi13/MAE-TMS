...
\begin{enumerate}
    ...
    \item El puntuación del agente $k$ incorpora un \textbf{compuerta de containment}:
    \begin{equation}
        s_k = \begin{cases}
...
(``el agente $k$ conoce'').
El puntuación B1 se define como:
\begin{equation}
...
El puntuación cruda de una proyección hetero-asociativa crece con la masa de registros,
...
El recuperación $\beta$ devuelve una \emph{muestra} de la distribución de labels acumulada
