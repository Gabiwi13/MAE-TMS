...
multi-agente construido con EAM y su extensión hetero-asociativa (EHAM)
...
TME (\textit{Transactive Memory Expert}), que coordina la fase temprana y deja
de hacer falta cuando cada agente forma su propio directorio interno.

% -------------------------------------------------------
\section{Memoria Asociativa Entrópica}

Toda la maquinaria del sistema se apoya en la EAM de Pineda y Morales y en su
extensión hetero-asociativa (EHAM) \cite{pineda2021entropic,morales2024hetero}.
...
La Memoria Hetero-Asociativa Entrópica (EHAM) \cite{morales2024hetero} relaciona
dos dominios en un tensor
...
que cada agente requiera cinco memorias (dos homo, una de contenido y dos
directorios: texto y visual).

% -------------------------------------------------------
\section{El sistema EAM-TMS}

El sistema contiene \textbf{17 memorias asociativas}: cinco por agente y dos
...
\begin{table}[H]
\centering
\caption{Las 17 memorias del sistema. Las de directorio asocian la
representación del cue con la identidad del agente ganador $g$ (one-hot,
$q{=}2$). Cada agente tiene dos directorios: texto ($M_{\mathrm{dir}}$) y
visual ($M^R_{\mathrm{dir}}$), uno por modalidad de pista.}
\label{tab:memorias}
\small
\begin{tabular}{@{}llll@{}}
\toprule
