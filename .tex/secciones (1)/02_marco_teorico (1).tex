...
Se dice que la pista $\mathbf{a}$ está \emph{contenido} en $\mathbf{R}$ si, para toda
...
todos las características de la pista tienen soporte simultáneo en la memoria.
Los pesos $w'_i$ ponderan la suma por la frecuencia con que cada característica de la pista
ha sido observado en la memoria homo-asociativa: características muy frecuentes en la pista
...
dominio: genera pesos $w_i$ que reflejan cuán típico es una pista dentro de ese espacio.
