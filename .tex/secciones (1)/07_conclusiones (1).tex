...
Este trabajo describió EAM-TMS, un sistema de memoria transactiva multi-agente construido sobre Memorias Asociativas Entrópicas (EAM)~\cite{pineda2021entropic,pineda2024hetero}.
...
El directorio transactivo se formó por interacción sin supervisión explícita, alcanzando un balance de \textbf{98.3\%} del máximo teórico (1.558 de 1.585 bits) con counts $[68, 54, 42]$.
Con presentación intercalada, la transición al 90\% de precisión ocurrió en \textbf{$k = 14$ interacciones}, lo que muestra que el directorio aprende rápido cuando la exposición es diversa.
...
El punto central del trabajo es que el comportamiento anómalo observado inicialmente (sesgo de densidad, recalls sin variedad) no era un defecto del modelo EAM sino consecuencia de un llenado con prototipos promedio.
