...
``más probable'' columna a columna es \emph{peor} que una muestra aleatoria con suerte
y muchísimo peor que cualquier método con prueba (7.0--9.0 contra 0.0 de ST/SS).
...
\begin{enumerate}
    ...
    \item \textbf{RS y ST se caracterizaron con corridas individuales.} La jerarquía
    fue estable en todas las ejecuciones observadas, pero una caracterización
    distribucional (medias y varianzas sobre $n$ corridas por pista, más pistas
    ambiguas donde SS deba superar a ST) daría el resultado fino.
    ...
    \item \textbf{Herencia de los límites del hemisferio visual.} El 25\% de rechazo
    residual del experimento base se manifiesta también en vivo; el laboratorio no lo
    empeora, pero tampoco lo resuelve.
\end{enumerate}
