...
\begin{enumerate}
    ...
    Escucha permanente con detección de actividad de voz por energía (piso de ruido
    adaptativo, implementación propia del laboratorio), subtítulos parciales en vivo y
    enrutamiento automático al detectar la pausa del hablante ($\sim$600 ms de
    silencio).
