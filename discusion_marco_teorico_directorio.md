...
- Los demás conocen ese dominio por descripción: presenciaron que el especialista ganaba y guardaron una envolvente de qué ganaba. Exp8 midió esa envolvente sin nombrarla: correctamente ubicada (vecino más cercano y centroide de la clase pedida siempre) y a la vez fuera de la nube de instancias reales (3 a 7 veces más lejos de cualquier instancia de lo que las instancias están entre sí).
