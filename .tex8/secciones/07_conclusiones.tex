...
\begin{enumerate}
    \item \textbf{Costo de la doble compuerta de contenido}: la compuerta ya cierra la
    fuga fuera de dominio (Sección~\ref{sec:limitaciones}); falta medir cuánta
    cobertura legítima cuesta sobre el banco reservado.
