...
\begin{enumerate}
    \item \textbf{Criterio de varianza mínima de la entrada visual}: la augmentación
    del llenado ya se midió (experimento 13: cobertura de 66.5 a 94.5\,\% con 16
    variantes en contenido y directorio, a costa de un falso ruteo de 656 y de que la
    sonda de color sólido se acepte más); falta cerrar esa fuga de entradas degeneradas
    antes de la memoria y decidir si el llenado con 16 variantes pasa a ser el oficial.
