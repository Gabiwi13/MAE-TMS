...
La consecuencia, verificada sobre la partición persistida, es que \textbf{los diez
objetos físicos de cada clase aportan vistas tanto a train como a test} (solape de
instancias del 100\%): toda imagen de prueba es una vista nueva de un objeto cuyas
demás vistas participaron del llenado o de la formación del directorio.
Las cifras del hemisferio visual de este reporte miden, en consecuencia,
generalización a \emph{vistas nuevas de objetos conocidos}, no a objetos nuevos;
la partición leave-one-object-out, protocolo estándar de ETH-80, queda declarada
como trabajo futuro (Sección~\ref{sec:limitaciones}).
